...
#define NativeBridge(fn, rtn, ...) JNIEXPORT rtn JNICALL  Java_com_originsu_manager_Natives_##fn(JNIEnv* env, jclass clazz, __VA_ARGS__)
#define NativeBridgeNP(fn, rtn) JNIEXPORT rtn JNICALL Java_com_originsu_manager_Natives_##fn(JNIEnv* env, jclass clazz)
