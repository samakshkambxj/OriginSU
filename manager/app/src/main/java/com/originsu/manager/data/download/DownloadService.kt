package com.originsu.manager.data.download
...
import com.originsu.manager.data.update.ZipRangeArchive
...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.originsu.manager.action.DOWNLOAD"
        const val ACTION_DOWNLOAD_MANAGER_APK = "com.originsu.manager.action.DOWNLOAD_MANAGER_APK"
        const val ACTION_CANCEL = "com.originsu.manager.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.originsu.manager.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.originsu.manager.action.INSTALL_MODULE"
